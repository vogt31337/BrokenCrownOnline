 ...
 * @author mvogt
 */
public class ZoomingTest {

    /**
     * Demo of a challenge I have with zooming inside a {@code ScrollPane}. <br>
     * I am running JavaFx 2.2 on a Mac. {@code java -version} yields:
     * <pre>
     * java version "1.7.0_09"
     * Java(TM) SE Runtime Environment (build 1.7.0_09-b05)
     * Java HotSpot(TM) 64-Bit Server VM (build 23.5-b02, mixed mode)
     * </pre> 6 rectangles are drawn, and can be zoomed in and out using either
     * <pre>
     * Ctrl + Mouse Wheel
     * or Ctrl + 2 fingers on the pad.
     * </pre> It reproduces a problem I experience inside an application I am
     * writing. If you magnify to {@link #MAX_SCALE}, an interesting problem
     * occurs when you try to zoom back to {@link #MIN_SCALE}. In the beginning
     * you will see that the {@code scrollPane} scrolls and consumes the
     * {@code ScrollEvent} until we have scrolled to the bottom of the window.
     * Once the bottom of the window is reached, it behaves as expected (or at
     * least as I was expecting).
     *
